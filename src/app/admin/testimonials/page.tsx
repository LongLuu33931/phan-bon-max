  ...
  return (
    <AdminShell>
      <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.14em] text-emerald-700">Trải nghiệm khách hàng</p>
          <h1 className="mt-2 text-3xl font-black tracking-tight text-stone-950">Feedback khách hàng</h1>
        </div>
