...
export const categories: Category[] = [
    {
        ...
        description:
            "Giải pháp cho đất chai, rễ yếu, cây suy và cần hồi phục nhanh.",
        sortOrder: 1,
        isActive: true,
    },
    {
    ...
    },
    {
        ...
        description:
            "Nuôi trái lớn, đẹp mẫu, chắc cây và tăng giá trị thương phẩm.",
        sortOrder: 3,
        isActive: true,
    },
    {
        ...
        description:
            "Kích hoa đồng loạt, tăng đậu trái, hạn chế rụng và nứt trái.",
        sortOrder: 4,
        isActive: true,
    },
];
...
export const products: Product[] = [
    {
        ...
        shelfLife: "24 tháng",
        shortDescription:
            "Kích rễ mới, phục hồi bộ rễ yếu và giúp cây bung đọt nhanh sau giai đoạn suy.",
        description:
        ...
        specs: [
            ...
            { label: "Khối lượng tịnh", value: "500g" },
            {
                ...
                value: "Kích rễ, bung đọt, phục hồi cây suy",
            },
            {
                label: "Đối tượng sử dụng",
                value: "Cây ăn trái, rau màu, hoa kiểng, cây công nghiệp",
            },
        ],
        benefits: [
            {
                title: "Rễ mới khỏe",
                description:
                    "Hỗ trợ ra rễ tơ, tăng khả năng hút nước và dinh dưỡng.",
            },
            {
                title: "Bung đọt nhanh",
                description:
                    "Giúp cây bật chồi non đều sau khi phục hồi bộ rễ.",
            },
            {
                title: "Giảm suy cây",
                description:
                    "Phù hợp vườn sau thu hoạch, sau hạn mặn hoặc stress thời tiết.",
            },
        ],
        ...
        seoDescription:
            "RootMax NPK8000 giúp kích rễ, bung đọt và phục hồi cây suy.",
    },
    {
        id: "prod-soilmax",
        categoryId: "cat-recovery",
        ...
        shelfLife: "24 tháng",
        shortDescription:
            "Hỗ trợ cải tạo đất chai cứng, tạo môi trường rễ thông thoáng và khỏe hơn.",
        description:
        ...
        specs: [
            ...
            {
                label: "Công dụng chính",
                value: "Cải tạo đất, hỗ trợ rễ, tăng hấp thu",
            },
        ],
        benefits: [
            {
                title: "Đất tơi hơn",
                description:
                    "Hỗ trợ cải thiện vùng rễ trong đất canh tác lâu năm.",
            },
            {
                title: "Rễ dễ thở",
                description:
                    "Tạo điều kiện để rễ phát triển đều và hấp thu dinh dưỡng tốt hơn.",
            },
        ],
        usageRows: defaultUsage,
        reasons: baseReasons,
        ...
        seoDescription:
            "Soil Max 8000 hỗ trợ cải tạo đất chai cứng và phục hồi nền rễ.",
    },
    {
        id: "prod-recover",
        categoryId: "cat-recovery",
        ...
        shelfLife: "24 tháng",
        shortDescription:
            "Dùng cho cây vàng lá, suy sau thu hoạch, stress do thời tiết hoặc chăm sóc sai nhịp.",
        description:
            "Recover Max hỗ trợ cây phục hồi sinh lực, tái tạo lá và rễ để quay lại chu kỳ phát triển ổn định.",
        specs: [
            { label: "Dạng", value: "Bột" },
            { label: "Khối lượng tịnh", value: "500g" },
            {
                label: "Công dụng chính",
                value: "Phục hồi cây suy, xanh lá, tăng sức cây",
            },
        ],
        benefits: [
            {
                title: "Phục hồi nhanh",
                description:
                    "Bổ sung dinh dưỡng cân bằng cho giai đoạn cây yếu.",
            },
            {
                title: "Xanh lá trở lại",
                description:
                    "Hỗ trợ lá dày và xanh, hạn chế biểu hiện thiếu sức.",
            },
        ],
        usageRows: defaultUsage,
        reasons: baseReasons,
        ...
        seoDescription:
            "Recover Max 8000 hỗ trợ phục hồi cây suy, vàng lá và stress.",
    },
    {
        id: "prod-grow",
        ...
        shelfLife: "24 tháng",
        shortDescription:
            "Giúp cây phát triển cân đối, khỏe thân lá và chuẩn bị tốt cho giai đoạn sau.",
        description:
            "Grow Max phù hợp giai đoạn cây con, sau phục hồi hoặc lúc cần tăng sinh trưởng thân lá ổn định.",
        specs: [
            { label: "Dạng", value: "Bột hòa tan" },
            { label: "Khối lượng tịnh", value: "500g" },
        ...
        benefits: [
            {
                title: "Cây lớn đều",
                description: "Hỗ trợ sinh trưởng cân đối, không thúc quá gắt.",
            },
            {
                title: "Nền cây khỏe",
                description: "Tạo nền cho giai đoạn ra hoa và nuôi trái.",
            },
        ],
        usageRows: defaultUsage,
        reasons: baseReasons,
        ...
        seoDescription:
            "Grow Max 8000 hỗ trợ cây khỏe, thân lá phát triển đều.",
    },
    {
        id: "prod-shoot",
        categoryId: "cat-growth",
        ...
        shelfLife: "24 tháng",
        shortDescription:
            "Tập trung hỗ trợ bung chồi non, ra đọt đều và phục hồi tán lá.",
        description:
            "Shoot Max dùng khi cây cần ra đọt đồng loạt, đặc biệt sau cắt tỉa, sau thu hoạch hoặc sau phục hồi.",
        specs: [
            { label: "Dạng", value: "Bột" },
            { label: "Khối lượng tịnh", value: "500g" },
            {
                label: "Công dụng chính",
                value: "Bung chồi, ra đọt, phục hồi tán",
            },
        ],
        benefits: [
            {
                title: "Đọt ra đều",
                description: "Hỗ trợ chồi non phát triển đồng loạt.",
            },
            {
                title: "Tán khỏe",
                description:
                    "Giúp bộ lá mới phát triển tốt hơn cho chu kỳ sau.",
            },
        ],
        usageRows: defaultUsage,
        reasons: baseReasons,
        ...
        seoDescription:
            "Shoot Max 8000 hỗ trợ bung đọt, ra chồi và phục hồi tán cây.",
    },
    {
        id: "prod-leaf",
        categoryId: "cat-growth",
        ...
        shelfLife: "24 tháng",
        shortDescription:
            "Giúp lá xanh, dày, khỏe và nâng hiệu suất quang hợp cho cây.",
        description:
            "Leaf Max tập trung vào chất lượng bộ lá, phù hợp cây vàng lá, lá mỏng hoặc cần tăng sức trước khi làm hoa.",
        specs: [
            { label: "Dạng", value: "Bột hòa tan" },
            { label: "Khối lượng tịnh", value: "500g" },
            {
                label: "Công dụng chính",
                value: "Xanh lá, dày lá, tăng quang hợp",
            },
        ],
        benefits: [
            {
                title: "Lá dày xanh",
                description: "Hỗ trợ cải thiện màu lá và độ dày lá.",
            },
            {
                title: "Cây sung sức",
                description: "Bộ lá khỏe giúp cây tích lũy tốt hơn.",
            },
        ],
        usageRows: defaultUsage,
        reasons: baseReasons,
    ...
    },
    {
        ...
        specs: [
            ...
            { label: "Khối lượng tịnh", value: "500g" },
            {
                ...
                value: "Đạm (N) 7%; Lân (P2O5) 5%; Kali (K2O) 44%; Độ ẩm 5%",
            },
            {
                label: "Công dụng chính",
                value: "Nuôi trái lớn nhanh, bóng trái, nặng ký",
            },
            {
                label: "Đối tượng sử dụng",
                value: "Lúa, rau màu, hoa cảnh, cây ăn trái và cây công nghiệp",
            },
        ],
        benefits: [
            {
                title: "Trái lớn nhanh - nặng ký",
                description:
                    "Thúc đẩy vận chuyển dinh dưỡng về trái, giúp trái phát triển chắc thịt và tăng trọng lượng.",
            },
            {
                title: "Lên màu đồng đều",
                description:
                    "Hỗ trợ trái lên màu đẹp, vỏ bóng và tăng tính thương phẩm.",
            },
            {
                title: "Tăng độ ngọt và hương vị",
                description:
                    "Tăng tích lũy đường, tinh bột để trái đậm vị hơn.",
            },
            {
                title: "Chuẩn chất lượng thương phẩm",
                description: "Giúp trái chắc khỏe, tươi lâu hơn sau thu hoạch.",
            },
        ],
        usageRows: [
            {
                crop: "Lúa",
                dosage: "Pha 1 hũ 500g cho 800 lít nước (2.000 m2)",
                timing: "Bón 3 lần: 7 ngày sau sạ, trước trổ đồng và sau khi trổ đều.",
            },
            {
                crop: "Rau màu",
                dosage: "Pha 1 hũ 500g cho 800 lít nước (2.000 m2)",
                timing: "Dùng từ khi có 3-4 lá thật đến trước thu hoạch, cách nhau 10-15 ngày.",
            },
            {
                crop: "Hoa, cây cảnh",
                dosage: "Pha 1 hũ 500g cho 1.000 lít nước (2.500 m2)",
                timing: "Bón trước khi nảy chồi và kỳ ra nụ hoa.",
            },
            {
                crop: "Cây ăn trái, công nghiệp",
                dosage: "Pha 1 hũ 500g cho 400 lít nước (1.000 m2)",
                timing: "Dùng khi hoa mới nhú và khi trái non mới hình thành.",
            },
        ],
        reasons: [
        ...
        seoDescription:
            "Fruit Max NPK 8000 giàu Kali 44%, giúp trái lớn nhanh, bóng đẹp và nặng ký.",
    },
    {
        id: "prod-stem",
        categoryId: "cat-fruit",
        ...
        shelfLife: "24 tháng",
        shortDescription:
            "Hỗ trợ thân cành cứng khỏe, giảm đổ ngã và giúp cây chịu tải trái tốt hơn.",
        description:
            "Stem Max phù hợp giai đoạn cây cần cứng thân, chắc cành, nâng sức chống chịu và bảo vệ năng suất.",
        specs: [
            { label: "Dạng", value: "Bột" },
            { label: "Khối lượng tịnh", value: "500g" },
            {
                label: "Công dụng chính",
                value: "Cứng cây, chắc thân, hạn chế đổ ngã",
            },
        ],
        benefits: [
            {
                title: "Thân cành vững",
                description: "Hỗ trợ mô cây chắc khỏe hơn.",
            },
            {
                title: "Chịu tải trái",
                description: "Giúp cây ổn định hơn trong giai đoạn nuôi trái.",
            },
        ],
        usageRows: defaultUsage,
        reasons: baseReasons,
        ...
        seoDescription:
            "Stem Max 8000 hỗ trợ cứng cây, chắc cành và bảo vệ năng suất.",
    },
    {
        id: "prod-flower",
        ...
        shelfLife: "24 tháng",
        shortDescription:
            "Hỗ trợ phân hóa mầm hoa, ra hoa đồng loạt và tạo tiền đề đậu trái tốt.",
        description:
            "Flower Max dùng cho giai đoạn chuẩn bị ra hoa, giúp hoa ra đều, khỏe và tăng cơ hội đậu trái.",
        specs: [
            { label: "Dạng", value: "Bột" },
            { label: "Khối lượng tịnh", value: "500g" },
            {
                label: "Công dụng chính",
                value: "Kích hoa, ra hoa đồng loạt, tăng đậu trái",
            },
        ],
        benefits: [
            {
                title: "Hoa ra đồng loạt",
                description: "Hỗ trợ phân hóa và bung hoa đều hơn.",
            },
            {
                title: "Hoa khỏe",
                description:
                    "Tạo nền dinh dưỡng cho giai đoạn thụ phấn và đậu trái.",
            },
        ],
        usageRows: defaultUsage,
        reasons: baseReasons,
        ...
        seoDescription:
            "Flower Max 8000 hỗ trợ kích hoa, ra hoa đồng loạt và tăng đậu trái.",
    },
    {
        id: "prod-cal",
        categoryId: "cat-flower",
        ...
        specs: [
            ...
            {
                label: "Thành phần chính",
                value: "Canxi (Ca) 7%; Bo (B) 20.000 ppm",
            },
            { label: "Chỉ số hỗ trợ", value: "pH H2O: 4; Tỷ trọng: 1,2" },
            {
                label: "Công dụng chính",
                value: "Chống rụng hoa, nứt trái, méo trái",
            },
            {
                label: "Đối tượng sử dụng",
                value: "Cây lương thực, cây ăn trái, cây công nghiệp, rau màu và hoa kiểng",
            },
        ],
        benefits: [
            {
                title: "Đậu trái và chống rụng",
                description:
                    "Tăng sức sống hạt phấn, giúp cuống trái chắc khỏe và hạn chế rụng trái non.",
            },
            {
                title: "Lớn trái và đẹp màu",
                description:
                    "Hỗ trợ trái phát triển cân đối, bóng đẹp, giảm nứt và méo trái.",
            },
            {
                title: "Tăng độ ngọt và bảo quản",
                description:
                    "Hỗ trợ tích lũy đường, cải thiện độ cứng trái và thời gian tươi sau thu hoạch.",
            },
        ],
        usageRows: [
            {
                crop: "Cây lương thực",
                dosage: "1 hũ 500g cho 350-500 m2",
                timing: "Bón lót hoặc bón thúc tùy giai đoạn cây trồng.",
            },
            {
                crop: "Cây ăn trái, cây công nghiệp",
                dosage: "1 hũ 500g cho 250-350 m2",
                timing: "Bón định kỳ 2-3 lần/năm vào đầu, giữa và cuối mùa mưa.",
            },
            {
                crop: "Rau màu, hoa kiểng",
                dosage: "1 hũ 500g cho 350-500 m2",
                timing: "Bón định kỳ cách nhau 10-15 ngày/lần.",
            },
        ],
        reasons: [
        ...
        seoDescription:
            "Cal Max 8000 giàu Canxi và Bo, giúp cứng cuống, chống rụng hoa, nứt trái và méo trái.",
    },
];
...
export const posts: Post[] = [
    {
        ...
        excerpt:
            "Một số dấu hiệu như lá vàng, đọt chậm, rễ ít tơ thường báo hiệu cây cần được phục hồi đúng nhịp.",
        content:
    ...
    },
    {
        ...
        excerpt:
            "Nuôi trái cần đúng thời điểm để trái lớn đều, đẹp mẫu và hạn chế hao cây cuối vụ.",
        content:
